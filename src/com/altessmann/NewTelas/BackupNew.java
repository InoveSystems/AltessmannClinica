...
import com.altessmann.Backup_restore.*;
...
public class BackupNew extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextCaminho1 = new javax.swing.JTextField();
        jButtonCarregar1 = new javax.swing.JButton();
        jButtonIniciar3 = new javax.swing.JButton();
        jLabel10 = new javax.swing.JLabel();
        jLabel7 = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Altessmann Sistemas - Backup");
        setResizable(false);
        ...
        jLabel8.setText("Configurador de Backup");
        jPanel4.add(jLabel8);
        jLabel8.setBounds(30, 15, 310, 19);

        jLabel9.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel9.setText("Altessmann - www.altessmann.com.br");
        jPanel4.add(jLabel9);
        jLabel9.setBounds(205, 467, 250, 17);
        ...
        jScrollPane3.setViewportView(jTableConvenio);
        if (jTableConvenio.getColumnModel().getColumnCount() > 0) {
            jTableConvenio.getColumnModel().getColumn(0).setMinWidth(470);
            jTableConvenio.getColumnModel().getColumn(0).setPreferredWidth(470);
            jTableConvenio.getColumnModel().getColumn(0).setMaxWidth(470);
            jTableConvenio.getColumnModel().getColumn(1).setMinWidth(100);
            jTableConvenio.getColumnModel().getColumn(1).setPreferredWidth(100);
            jTableConvenio.getColumnModel().getColumn(1).setMaxWidth(100);
        }

        jPanel4.add(jScrollPane3);
        jScrollPane3.setBounds(40, 125, 602, 310);

        jTextCaminho1.setEditable(false);
        jTextCaminho1.setBackground(new java.awt.Color(255, 255, 255));
        jTextCaminho1.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jTextCaminho1.setForeground(new java.awt.Color(153, 153, 153));
        jTextCaminho1.setText("Caminho para Backup ...");
        jTextCaminho1.setMaximumSize(new java.awt.Dimension(1000, 10000));
        jTextCaminho1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextCaminho1ActionPerformed(evt);
            }
        });
        jPanel4.add(jTextCaminho1);
        jTextCaminho1.setBounds(40, 90, 295, 30);

        jButtonCarregar1.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        jButtonCarregar1.setText("Carregar Caminho");
        jButtonCarregar1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonCarregar1ActionPerformed(evt);
            }
        });
        jPanel4.add(jButtonCarregar1);
        jButtonCarregar1.setBounds(340, 90, 163, 30);

        jButtonIniciar3.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        jButtonIniciar3.setText("Salvar / Excluir");
        jButtonIniciar3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonIniciar3ActionPerformed(evt);
            }
        });
        jPanel4.add(jButtonIniciar3);
        jButtonIniciar3.setBounds(508, 90, 135, 30);

        jLabel10.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel10.setText("Adicione caminhos onde sera salvo os backups ");
        jPanel4.add(jLabel10);
        jLabel10.setBounds(30, 40, 320, 17);

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/ImagemFundoBackup.png"))); // NOI18N
        jPanel4.add(jLabel7);
        jLabel7.setBounds(0, 0, 680, 490);

        jTabbedPane1.addTab("  Configurações de Backup  ", jPanel4);
...
//    }
    ...
    private void jButtonIniciar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIniciar2ActionPerformed
        ...
        if ((jTextCaminho.getText().equals("Caminho do arquivo ...")) || (jTextCaminho.getText().equals(""))) {
            JOptionPane.showMessageDialog(null, "Caminho do arquivo Invalido! ", "Altessmann - Erro ao ler arquivo", JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    private void jTextCaminho1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextCaminho1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextCaminho1ActionPerformed

    private void jButtonCarregar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCarregar1ActionPerformed
        ...
        try {
            ...
            File f = chooser.getSelectedFile();
            String filename = f.getAbsolutePath();
            jTextCaminho1.setText(filename);
        } catch (NullPointerException ex) {

        }
    }//GEN-LAST:event_jButtonCarregar1ActionPerformed
    ...
    private javax.swing.JButton jButtonCarregar1;
    ...
    public javax.swing.JTextField jTextCaminho1;
