...
//========================================================
    ...
    class MultiFileTransferHandler implements TransferListener {
         ...
         * the image is provided as an argument. The image type may vary
         * depending on the interface (Wia/ICA) and the device driver. Typical
         * format includes BMP for WIA scanners and JPEG for WIA camera and for
         * ICA devices. Please note that this method runs in different thread
